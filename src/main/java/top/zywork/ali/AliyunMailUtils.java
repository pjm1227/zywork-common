...
public class AliyunMailUtils {
     ...
     * @return
     */
    public static SingleSendMailResponse sendEmail(String accountName, String fromAlias, String toAddress, boolean applyToAddress, String subject, String htmlBody, String tagName) {
     ...
     * @return
     */
    public static BatchSendMailResponse batchSendEmail(String accountName, String templateName, String receiversName, String tagName) {
        // 如果是除杭州region外的其它region（如新加坡、澳洲Region），需要将下面的"cn-hangzhou"替换为"ap-southeast-1"、或"ap-southeast-2"。
        IClientProfile profile = DefaultProfile.getProfile("cn-hangzhou", accessKeyId, accessKeySecret);
        // 如果是除杭州region外的其它region（如新加坡region）， 需要做如下处理
        //try {
